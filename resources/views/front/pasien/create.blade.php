...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal bucket-form" method="post" action="{{url('fpasiens')}}"
                  enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label class="col-sm-6 control-label">No RM</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="no_rm" value="{{$newRM}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-6 control-label">Nama Pasien</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_pasien" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-6 control-label">NIK</label>
                            <div class="col-sm-8">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label class=" col-sm-6 control-label">Email / FB</label>
                            <div class="col-sm-8">
